...
with model:
    ...
    #Getting error from network
    #post_p = nengo.Probe(post, synapse=0.02) 
    ...
    output = nengo.Node(controls, size_in=1)
    
    input = nengo.Node(feedback, size_in=1)     # RMS = 0.5 by default
